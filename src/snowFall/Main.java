...
public class Main extends JPanel implements MouseListener,MouseMotionListener {
	...
	public static void main(String[] args) {
		...
		//画像読み込み操作一式
		try {
			pic[PIC_BG] = 			ImageIO.read(new File("resources/bgXmas.jpg"));		//pro.photo.ne.jp
			pic[PIC_SNOW]=			ImageIO.read(new File("resources/snowBefore.png"));
			pic[PIC_CRYSTAL]=		ImageIO.read(new File("resources/snowAfter.png"));
			pic[PIC_SNOW_ANIM5+0]=	ImageIO.read(new File("resources/snowChanges1.png"));
			pic[PIC_SNOW_ANIM5+1]=	ImageIO.read(new File("resources/snowChanges2.png"));
			pic[PIC_SNOW_ANIM5+2]=	ImageIO.read(new File("resources/snowChanges3.png"));
			pic[PIC_SNOW_ANIM5+3]=	ImageIO.read(new File("resources/snowChanges4.png"));
			pic[PIC_SNOW_ANIM5+4]=	ImageIO.read(new File("resources/snowChanges5.png"));
//			pic[PIC_LINE_ON]=		ImageIO.read(new File("resources/linearElementON.png"));
//			pic[PIC_LINE_OFF]=		ImageIO.read(new File("resources/linearElementOFF.png"));
			pic[PIC_TITLE]=			ImageIO.read(new File("resources/title.png"));
			pic[PIC_COMBO]=			ImageIO.read(new File("resources/combo.png"));
			for(int i=0;i<10;i++)
				pic[PIC_NUMBERS10+i]=	ImageIO.read(new File("resources/comboNumbers"+i+".png"));
			pic[PIC_1UP]=			ImageIO.read(new File("resources/1UP.png"));
		...
		//効果音読み込み操作一式
		wav[WAV_GOOD]=				new ClipControl(new File("resources/good.wav"));			//魔王魂　より
		wav[WAV_CHANGE]=			new ClipControl(new File("resources/change.wav"));
		wav[WAV_1UP]=				new ClipControl(new File("resources/1UP.wav"));
		wav[WAV_BUTTON]=			new ClipControl(new File("resources/button.wav"));
		wav[WAV_OPENING]=			new ClipControl(new File("resources/opening.wav"));
		wav[WAV_MISS]=				new ClipControl(new File("resources/miss.wav"));
		wav[WAV_GAMEOVER]=			new ClipControl(new File("resources/gameover.wav"));

		//MIDI読み込み操作一式
//		mid[MID_CRYSTAL]=			new MIDIControl("resources/crystal.mid");
